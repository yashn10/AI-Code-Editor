...
const page = () => {
    ...
    return (
        ...
        <div className="relative isolate px-6 py-24 sm:py-32 lg:px-8 min-w-full">
                ...
                {tiers.map((tier, tierIdx) => (
                    ...
                    >
                        ...
                        <a
                            ...
                            className={classNames(
                                tier.featured
                                    ? 'bg-indigo-700 text-white shadow-xs hover:bg-indigo-900 focus-visible:outline-indigo-500'
                                    : 'text-indigo-600 ring-1 ring-indigo-600 ring-inset hover:ring-indigo-400 focus-visible:outline-indigo-600',
